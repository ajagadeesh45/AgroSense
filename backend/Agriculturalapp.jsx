...
/* ═══════════════════════════════════════
   CONFIG
═══════════════════════════════════════ */
const API         = "https://agrosense-api.onrender.com/api";
...
═══════════════════════════════════════ */
/* ── Farming background helpers ── */
function SunRays() {
  return (
    <div style={{position:"absolute",top:"-8%",right:"-4%",width:240,height:240,zIndex:1}}>
      <svg width="240" height="240" viewBox="0 0 240 240">
        ...
        <circle cx="120" cy="120" r="120" fill="url(#sunG)"/>
        {[0,30,60,90,120,150,180,210,240,270,300,330].map(a=>(
          <line key={a}
            x1={120+50*Math.cos(a*Math.PI/180)} y1={120+50*Math.sin(a*Math.PI/180)}
            x2={120+110*Math.cos(a*Math.PI/180)} y2={120+110*Math.sin(a*Math.PI/180)}
            stroke="#fde68a" strokeWidth="2" strokeOpacity="0.3" strokeLinecap="round"/>
        ))}
        <circle cx="120" cy="120" r="40" fill="#fef3c7" opacity="0.85"
          style={{animation:"sunPulse 4s ease-in-out infinite"}}/>
        <circle cx="120" cy="120" r="26" fill="#fde68a" opacity="0.9"
          style={{animation:"sunPulse 4s ease-in-out infinite"}}/>
      </svg>
    </div>
  );
...
function FarmBG() {
  return (
    <div style={{
      ...
      background:"linear-gradient(175deg,#f0fdf4 0%,#dcfce7 25%,#ecfdf5 55%,#f0fdfa 75%,#fffbeb 100%)"
    }}>
      <style>{`
        @keyframes sunPulse{0%,100%{transform:scale(1);opacity:.9}50%{transform:scale(1.06);opacity:1}}
        @keyframes sway{0%,100%{transform:rotate(-4deg)}50%{transform:rotate(4deg)}}
        @keyframes cloudMove{0%{transform:translateX(-200px)}100%{transform:translateX(115vw)}}
        @keyframes birdFly{0%{transform:translateX(-80px) translateY(0)}50%{transform:translateX(45vw) translateY(-18px)}100%{transform:translateX(115vw) translateY(5px)}}
        @keyframes tractorGo{0%{transform:translateX(-170px)}100%{transform:translateX(115vw)}}
        @keyframes dropFall{0%{transform:translateY(-10px);opacity:0}50%{opacity:.5}100%{transform:translateY(55px);opacity:0}}
      ...
      {/* Clouds */}
      {[{top:"7%",dur:"34s",delay:"0s",s:1},{top:"13%",dur:"46s",delay:"13s",s:.65},{top:"4%",dur:"40s",delay:"24s",s:.8}].map((cl,i)=>(
        <div key={i} style={{position:"absolute",top:cl.top,left:"-200px",zIndex:2,
          animation:"cloudMove "+cl.dur+" linear "+cl.delay+" infinite"}}>
          <svg width={Math.round(110*cl.s)} height={Math.round(52*cl.s)} viewBox="0 0 110 52">
            <ellipse cx="55" cy="36" rx="50" ry="17" fill="white" opacity="0.78"/>
            <ellipse cx="36" cy="28" rx="27" ry="19" fill="white" opacity="0.78"/>
            <ellipse cx="70" cy="27" rx="22" ry="17" fill="white" opacity="0.78"/>
            <ellipse cx="52" cy="20" rx="17" ry="14" fill="white" opacity="0.68"/>
          </svg>
        </div>
      ))}

      {/* Birds */}
      {[{top:"17%",delay:"6s",dur:"19s"},{top:"12%",delay:"14s",dur:"25s"}].map((b,i)=>(
        <div key={i} style={{position:"absolute",top:b.top,zIndex:3,
          animation:"birdFly "+b.dur+" linear "+b.delay+" infinite"}}>
          <svg width="28" height="14" viewBox="0 0 28 14">
            <path d="M0 9 Q7 2 14 9 Q21 2 28 9" stroke="#065f46" strokeWidth="1.8" fill="none" strokeLinecap="round"/>
          </svg>
        </div>
      ))}

      {/* Floating leaves */}
      {[{l:"4%",t:"22%",s:30,d:0,r:-20},{l:"87%",t:"28%",s:22,d:.8,r:30},
        {l:"14%",t:"58%",s:26,d:1.5,r:-10},{l:"82%",t:"52%",s:18,d:.4,r:45},
        {l:"48%",t:"16%",s:20,d:1.2,r:-30},{l:"91%",t:"68%",s:24,d:.6,r:15}].map((lf,i)=>(
        <div key={i} style={{position:"absolute",left:lf.l,top:lf.t,zIndex:2,
          animation:"leafFloat "+(3+lf.d)+"s ease-in-out "+lf.d+"s infinite",
          transform:"rotate("+lf.r+"deg)"}}>
          <svg width={lf.s} height={lf.s} viewBox="0 0 40 40">
            <path d="M20 2 C20 2 4 10 4 22 C4 32 11 38 20 38 C29 38 36 32 36 22 C36 10 20 2 20 2Z"
              fill="#22c55e" opacity="0.15"/>
            <line x1="20" y1="38" x2="20" y2="10" stroke="#16a34a" strokeWidth="1" opacity="0.2"/>
            <line x1="20" y1="22" x2="13" y2="17" stroke="#16a34a" strokeWidth=".8" opacity="0.18"/>
            <line x1="20" y1="28" x2="12" y2="25" stroke="#16a34a" strokeWidth=".8" opacity="0.18"/>
            <line x1="20" y1="22" x2="27" y2="17" stroke="#16a34a" strokeWidth=".8" opacity="0.18"/>
            <line x1="20" y1="28" x2="28" y2="25" stroke="#16a34a" strokeWidth=".8" opacity="0.18"/>
          </svg>
        </div>
      ))}
      ...
      <div style={{position:"absolute",bottom:0,left:0,right:0,height:"30%",zIndex:2,
        background:"linear-gradient(180deg,transparent 0%,rgba(187,247,208,.3) 50%,rgba(134,239,172,.2) 100%)"}}>
        {/* Wheat row */}
        <div style={{position:"absolute",bottom:0,left:0,right:0,display:"flex",
          justifyContent:"space-around",alignItems:"flex-end"}}>
          {[...Array(24)].map((_,i)=>(
            <div key={i} style={{
              animation:"sway "+(1.8+i%3*.35)+"s ease-in-out "+(i*.12)+"s infinite",
              transformOrigin:"bottom center"}}>
              <svg width="16" height="62" viewBox="0 0 16 62">
                <ellipse cx="8" cy="7" rx="3.5" ry="6" fill="#d97706" opacity="0.45"/>
                <ellipse cx="4.5" cy="11" rx="2.5" ry="4" fill="#d97706" opacity="0.35"/>
                <ellipse cx="11.5" cy="11" rx="2.5" ry="4" fill="#d97706" opacity="0.35"/>
                <line x1="8" y1="14" x2="8" y2="62" stroke="#65a30d" strokeWidth="1.5" opacity="0.4"/>
                <path d="M8 32 Q2 27 3 21" stroke="#65a30d" strokeWidth="1" fill="none" opacity="0.35"/>
                <path d="M8 42 Q14 37 13 30" stroke="#65a30d" strokeWidth="1" fill="none" opacity="0.35"/>
              </svg>
            </div>
          ))}
        </div>
      ...
      {/* Tractor */}
      <div style={{position:"absolute",bottom:"5%",zIndex:4,
        animation:"tractorGo 24s linear 5s infinite"}}>
        <svg width="90" height="52" viewBox="0 0 90 52">
          <rect x="20" y="14" width="50" height="23" rx="5" fill="#b91c1c" opacity="0.5"/>
          <rect x="28" y="7" width="28" height="21" rx="4" fill="#dc2626" opacity="0.45"/>
          <rect x="32" y="10" width="18" height="12" rx="2" fill="#bae6fd" opacity="0.55"/>
          <rect x="20" y="28" width="50" height="4" rx="1" fill="#14b8a6" opacity="0.4"/>
          <rect x="64" y="5" width="4" height="13" rx="2" fill="#6b7280" opacity="0.35"/>
          <circle cx="64" cy="3" r="3.5" fill="#d1d5db" opacity="0.28"
            style={{animation:"float 1.2s ease-in-out infinite"}}/>
          <circle cx="30" cy="41" r="13" fill="#1e293b" opacity="0.38"/>
          <circle cx="30" cy="41" r="8"  fill="#334155" opacity="0.42"/>
          <circle cx="30" cy="41" r="3"  fill="#94a3b8" opacity="0.45"/>
          {[0,60,120,180,240,300].map(a=>(
            <line key={a}
              x1={30+8*Math.cos(a*Math.PI/180)} y1={41+8*Math.sin(a*Math.PI/180)}
              x2={30+13*Math.cos(a*Math.PI/180)} y2={41+13*Math.sin(a*Math.PI/180)}
              stroke="#0f172a" strokeWidth="2" opacity="0.28"/>
          ))}
          <circle cx="68" cy="42" r="8" fill="#1e293b" opacity="0.35"/>
          <circle cx="68" cy="42" r="4" fill="#334155" opacity="0.38"/>
          <ellipse cx="72" cy="27" rx="3" ry="2.5" fill="#2dd4bf" opacity="0.55"/>
          <circle cx="42" cy="10" r="5" fill="#fbbf24" opacity="0.5"/>
          <ellipse cx="42" cy="6" rx="7" ry="2.5" fill="#78350f" opacity="0.4"/>
        </svg>
      </div>

      {/* Sprout icons */}
      {[{l:"7%",t:"42%"},{l:"74%",t:"36%"},{l:"40%",t:"62%"},{l:"87%",t:"47%"}].map((s,i)=>(
        <div key={i} style={{position:"absolute",left:s.l,top:s.t,zIndex:2,
          animation:"leafFloat "+(3.5+i*.5)+"s ease-in-out "+(i*.8)+"s infinite",opacity:0.14}}>
          <svg width="24" height="30" viewBox="0 0 24 30">
            <circle cx="12" cy="24" r="6" fill="#92400e"/>
            <path d="M12 22 Q12 10 19 5" stroke="#16a34a" strokeWidth="2" fill="none" strokeLinecap="round"/>
            <ellipse cx="19" cy="5" rx="5" ry="3" fill="#22c55e" transform="rotate(-20 19 5)"/>
            <path d="M12 16 Q8 13 6 9" stroke="#16a34a" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
            <ellipse cx="6" cy="9" rx="4" ry="2.5" fill="#22c55e" transform="rotate(30 6 9)"/>
          </svg>
        </div>
      ))}
      ...
      {/* Water droplets */}
      {[...Array(5)].map((_,i)=>(
        <div key={i} style={{position:"absolute",left:(8+i*18)+"%",top:(18+i%3*14)+"%",zIndex:1,
          animation:"dropFall "+(2.2+i*.5)+"s ease-in "+(i*.8)+"s infinite"}}>
          <svg width="8" height="13" viewBox="0 0 8 13">
            <path d="M4 0 Q7 5 4 12 Q1 5 4 0Z" fill="#22d3ee" opacity="0.18"/>
          </svg>
        </div>
      ))}
      ...
      <div style={{position:"absolute",inset:0,zIndex:1,
        backgroundImage:"radial-gradient(circle,rgba(20,184,166,.055) 1px,transparent 1px)",
        backgroundSize:"30px 30px"}}/>

      {/* Green vignette edges */}
      <div style={{position:"absolute",inset:0,zIndex:1,
        background:"radial-gradient(ellipse at center,transparent 60%,rgba(187,247,208,.25) 100%)"}}/>
    </div>
  );
}
  ...
  return(
    <ScreenWrap>
      ...
      <div style={{
        ...
        padding:"54px 22px 0",color:"#fff",position:"relative",
        overflow:"hidden",
        borderBottom:"1px solid rgba(20,184,166,.2)"}}>

        {/* Decorative farming SVG in header */}
        <div style={{position:"absolute",bottom:0,right:0,opacity:.18,pointerEvents:"none"}}>
          <svg width="180" height="120" viewBox="0 0 180 120">
            {/* Field rows */}
            {[0,1,2,3].map(r=>(
              <ellipse key={r} cx="140" cy={90+r*8} rx="60" ry="4"
                fill="#22c55e" opacity={0.8-r*.15}/>
            ))}
            {/* Crop plants */}
            {[100,118,136,154,172].map((x,i)=>(
              <g key={i}>
                <line x1={x} y1="88" x2={x} y2="65" stroke="#4ade80" strokeWidth="2"/>
                <ellipse cx={x-5} cy="72" rx="7" ry="4" fill="#16a34a"
                  transform={"rotate(-30 "+(x-5)+" 72)"}/>
                <ellipse cx={x+5} cy="75" rx="7" ry="4" fill="#16a34a"
                  transform={"rotate(30 "+(x+5)+" 75)"}/>
              </g>
            ))}
            {/* Farmer silhouette */}
            <circle cx="40" cy="55" r="10" fill="#fbbf24" opacity="0.9"/>
            <rect x="33" y="65" width="14" height="20" rx="4" fill="#7c3aed" opacity="0.8"/>
            <rect x="27" y="67" width="8" height="14" rx="3" fill="#7c3aed" opacity="0.7"/>
            <rect x="45" y="67" width="8" height="14" rx="3" fill="#7c3aed" opacity="0.7"/>
            {/* Hat */}
            <ellipse cx="40" cy="46" rx="13" ry="3" fill="#78350f" opacity="0.9"/>
            <rect x="34" y="40" width="12" height="8" rx="3" fill="#92400e" opacity="0.9"/>
            {/* Tool */}
            <line x1="54" y1="50" x2="70" y2="90" stroke="#6b7280" strokeWidth="2.5"/>
            <ellipse cx="70" cy="92" rx="6" ry="3" fill="#4b5563"/>
            {/* Sun */}
            <circle cx="20" cy="20" r="12" fill="#fde68a" opacity="0.7"/>
            {[0,45,90,135,180,225,270,315].map(a=>(
              <line key={a}
                x1={20+13*Math.cos(a*Math.PI/180)}
                y1={20+13*Math.sin(a*Math.PI/180)}
                x2={20+18*Math.cos(a*Math.PI/180)}
                y2={20+18*Math.sin(a*Math.PI/180)}
                stroke="#fde68a" strokeWidth="1.5" opacity="0.5"/>
            ))}
            {/* Wheat stalks left */}
            {[10,20,30,50,60].map((x,i)=>(
              <g key={i}>
                <line x1={x} y1="90" x2={x} y2="68" stroke="#a16207" strokeWidth="1.5" opacity="0.7"/>
                <ellipse cx={x} cy="65" rx="3" ry="5" fill="#d97706" opacity="0.65"/>
              </g>
            ))}
          </svg>
        </div>
        ...
        <div style={{position:"absolute",top:"-30%",left:"-10%",width:200,height:200,
          borderRadius:"50%",background:"radial-gradient(circle,rgba(20,184,166,.15) 0%,transparent 70%)",
          pointerEvents:"none"}}/>
        ...
        {/* Welcome */}
        <p style={{margin:"0 0 4px",opacity:.65,fontSize:13,position:"relative",zIndex:2}}>
          {t("welcomeBack",lang)}
        </p>
        ...
        <p style={{margin:"0 0 0",opacity:.55,fontSize:12,position:"relative",zIndex:2}}>
          {t("age",lang)}: {age} {t("yrs",lang)}
        </p>

        {/* Wave divider at bottom of header */}
        <div style={{marginTop:20,marginLeft:-22,marginRight:-22,lineHeight:0}}>
          <svg viewBox="0 0 480 32" preserveAspectRatio="none"
            style={{width:"calc(100% + 44px)",height:32,display:"block"}}>
            <path d="M0,20 C80,35 160,5 240,20 C320,35 400,5 480,20 L480,32 L0,32Z"
              fill="#f0fdf4"/>
          </svg>
        </div>
      </div>
