"""
AgroSense Flask Backend — Clean Simple Version
No rejection logic. Just predict and return results.
"""
...
print(f"  [OK] leaf_disease_model.h5")
...
DISEASE_INFO = {
    ...
    "Pepper_bell_healthy": {
        ...
        "description":"Your pepper plant is healthy! No disease detected. Keep up the good care.",
    ...
    "Potato_healthy": {
        ...
        "severity":"None","recovery":"N/A — plant is healthy",
        "description":"Your potato plant is healthy! No disease detected. Continue regular care.",
    ...
    "Tomato_Tomato_YellowLeaf_Curl_Virus": {
        ...
        "description":"Tomato Yellow Leaf Curl Virus (TYLCV) spread by whiteflies. No chemical cure exists.",
...
CROP_TIPS = {
    ...
    "apple":{"season":"Hilly regions","water":"Medium","days":"150–180","tip":"Needs winter chill below 7°C."},
...
def disease_detect():
    ...
    try:
        ...
        top3 = [
            {
                ...
                "display":    DISEASE_INFO.get(DISEASE_CLASSES[int(i)],{}).get("display",""),
        ...
        return jsonify({
            ...
            "recovery":    info.get("recovery","Consult an expert"),
...
def price_predict():
    ...
    try:
        df = pd.DataFrame([{
            ...
            "Min Price":float(b["minPrice"]),"Max Price":float(b["maxPrice"]),
            "Year":float(b["year"]),"Month":float(b["month"]),"Day":float(b["day"]),
        }])
